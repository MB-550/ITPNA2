...
def display(serverClass=HTTPServer, handler_class=HTTP_System, port = 1229):#It is important to note that everytime you run you might have to change the port number
    server_address=('',port)
